...
if __name__ == '__main__':
    ...
    num_dict = {"small": 512, "middle": 1024, "large": 2048, "huge": 4096, "test": 8000}

    # ellipsoid
    for shape in ["bunny"]:
        for size in ["small", "middle", "large", "huge", "test"]:
            ...
            torch.save((surf_pts, normals, mean_curv), '../../data/{}_m_{}.pth'.format(shape, size))
